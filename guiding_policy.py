...
# --- File: guiding_policy.py ---
class GuidingPolicyAgent:
    """
    Generates a guiding policy from a diagnosis result.
    """
    def __init__(self):
        self.name = "GuidingPolicyAgent"

    def generate_policy(self, diagnosis_data: dict) -> dict:
        ...
        policy_templates = {
            ...
            'Unclassified': (
                'Clarify core issues and align resources toward primary objectives.'
            )
        }
        ...
        return {
            'policy': policy,
            'category': category,
            'aspects': diagnosis_data.get('aspects', [])
        }
