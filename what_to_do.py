# --- File: what_to_do.py ---
# Renamed CoherentActionsAgent -> WhatToDoAgent
class WhatToDoAgent:
    """
    Generates a step-by-step plan from solutions outline.
    """
    def __init__(self):
        self.name = "WhatToDoAgent"

    def generate_actions(self, solutions_data: dict) -> list[dict]:
        policy = solutions_data.get('policy', '')
